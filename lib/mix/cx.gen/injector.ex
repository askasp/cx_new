defmodule Mix.Cx.Gen.Injector do
  @moduledoc false
  ...
  def router_plug_inject(file, %{schema: schema}) when is_binary(file) do
  ...
  def router_plug_help_text(file_path, %{schema: schema}) do
    """
  ...
  defp router_plug_code(schema) do
